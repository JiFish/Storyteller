...
$booklist = [
    ...
    ['no01', 'lw/21votm',  'Voyage of the Moonstone',    'lw_neworder', 'Lone Wolf - New Order', 1],
    ['no02', 'lw/22tbos',  'The Buccaneers of Shadaki',  'lw_neworder', 'Lone Wolf - New Order', 2],
    ['no03', 'lw/23mh',    'Mydnight\'s Hero',           'lw_neworder', 'Lone Wolf - New Order', 3],
    ['no04', 'lw/24rw',    'Rune War',                   'lw_neworder', 'Lone Wolf - New Order', 4],
    ['no05', 'lw/25totw',  'Trail of the Wolf',          'lw_neworder', 'Lone Wolf - New Order', 5],
    ['no06', 'lw/26tfobm', 'The Fall of Blood Mountain', 'lw_neworder', 'Lone Wolf - New Order', 6],
    ['no07', 'lw/27v',     'Vampirium',                  'lw_neworder', 'Lone Wolf - New Order', 7],
    ['no08', 'lw/28thos',  'The Hunger of Sejanoz',      'lw_neworder', 'Lone Wolf - New Order', 8],
